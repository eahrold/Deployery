<template>
    <div class="row justify-content-start align-items-center" :class="{clickable: !!history}" @click='open'>
        <div class="col col-md-3 col-sm-6 text-nowrap">
            {{ history ? history.server.name : "Server" }}
        </div>

        <div class="col col-md-3 text-nowrap text-left d-none d-md-block">
            {{ history ? history.from_commit : "From" }} -> {{ history ? history.to_commit : "To" }}
        </div>

        <div class="col col-md-3 text-nowrap text-left d-none d-md-block mw-user">
            {{ history ?  history.user_name : "User" }}
        </div>

        <div class="col col-md-3 col-sm-6 text-nowrap text-left">
